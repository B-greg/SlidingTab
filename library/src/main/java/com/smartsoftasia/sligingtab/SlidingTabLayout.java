...
package com.smartsoftasia.sligingtab;
 ...
 * alternative is via the {@link com.smartsoftasia.neibo.sliding.SlidingTabLayout.TabColorizer} interface which provides you complete control over
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     * {@link #setCustomTabColorizer(com.smartsoftasia.neibo.sliding.SlidingTabLayout.TabColorizer)}.
     */
...
/*        Display display = ((FragmentActivity) context).getWindowManager().getDefaultDisplay();
        ...
        addView(mTabStrip, LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    }

    /**
     * Set the custom {@link com.smartsoftasia.neibo.sliding.SlidingTabLayout.TabColorizer} to be used.
     *
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link com.smartsoftasia.neibo.sliding.SlidingTabLayout} you are
    ...
    /**
     * Set the navigation mode. Should be NAVIGATION_MODE_STANDARD or NAVIGATION_MODE_TABS.
     */
